...
易装者（Cross-dressing，简写为CD），指基于各种理由、动机穿着通常被认为是异性装扮的人群，多被用于指代男性穿着（普遍认知）中女性装扮。

## 间性人

间性人（Intersex），指的是身体特征不符合传统二元性别定义的人，性发育障碍（DSD）作为医学上的症状诊断类型包含在其中，而旧称的两性畸形（Hermaphrodite)与俗称的双性人只是DSD的一部分表现形式。间性人目前是一个伞式词，其包括了性染色体、第一性征、第二性征、性激素水平等不符合传统二元性别标准的多种多样的情况。

## 女体性幻想

女体性幻想（Autogynephilia，简写为AG），指那些通过幻想自己是女性和具有女性性别表达并以此产生性欲的男性角色，这种概念曾被错误地用于解释跨性别女性成因，现已被推翻。
