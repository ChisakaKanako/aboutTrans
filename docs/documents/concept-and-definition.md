...
间性人（Intersex），指的是身体特征不符合传统二元性别定义的人，性发育障碍（DSD）作为医学上的症状诊断类型包含在其中，而旧称的两性畸形（Hermaphrodite)与俗称的双性人只是DSD的一部分表现形式。间性人是一个伞式术语，其包括了性染色体、第一性征、第二性征、性激素水平等不符合传统二元性别标准的多种多样的情况。
