...
<mark>进行跨性别身份的诊断需由三级甲等医疗机构的精神科医师进行，并不是所有的精神科医师都了解跨性别相关知识并出具相关诊断</mark>。相关诊断主要通过沟通（表明既往及目前状态和就诊诉求）和心理评估（如SCL90、MMPI等量表）进行，有些会包含激素、染色体等检查。相关诊断证明的开具流程因不同地区、医疗机构甚至医师而异，通常会需要1-2年的观察期。
...
性别肯定激素治疗包括女性化激素治疗和男性化激素治疗，分别适用于跨性别女性和跨性别男性。<mark>激素治疗的目的是为了暂停原指派性别的第二性征发展并促进自我认同的第二性征发展，以提升自我接纳和缓解性别焦虑，并改善心理健康。对于术后跨性别者则是维持对应性别的激素水平范围</mark>。需要注意的是，国内目前仅有少数几家医疗机构可以提供跨性别序列医疗，且激素治疗方案因人而异，<mark>无论选择何种治疗方案，都需要结合实际情况并根据自身需求来决定</mark>。
...
需要注意的是，不同医疗机构的前置检查项目可能并不相同。<mark>无论是否选择在医疗机构接受激素治疗，都建议每3个月复查肝肾功能和雌二醇、睾酮、泌乳素水平（男性倾向跨性别者无需此项），并每年进行一次身体全面检查</mark>。下文所示的激素治疗方案、效果及风险来自跨性别和多元性别人群健康照护指南第八版（SOC-8）[^1]，不构成专业医疗建议，具体用药方案需根据血激素水平动态调整。
...
跨性别言语训练（又称嗓音训练）是指通过训练的方式实现嗓音的改变。言语训练一般被视为性别肯定治疗的一部分，其目的是使接受训练者的嗓音听起来更符合其心理性别特征，从而增加被视为该性别的可能性，减少性别焦虑，提升幸福感和健康状况。
...
其中，基于康复医学的言语训练相较于基于声乐理论的练习对于声带和声道长度等生理条件的要求较低，但是其训练后的效果相对较差，但是两者可以能实现改变嗓音的目的。

### 基于康复医学的嗓音女性化训练简介

基于康复医学的言语训练主要通过改善受训练者发声的声学与感知差异（如基频、音色等）实现嗓音女性化。
